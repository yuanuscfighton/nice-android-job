package com.laioffer.my_network.demo2_okhttp_code.okhttp3

import okhttp3.internal.assertThreadDoesntHoldLock
import com.laioffer.my_network.demo2_okhttp_code.okhttp3.internal.connection.RealCall
import com.laioffer.my_network.demo2_okhttp_code.okhttp3.internal.connection.RealCall.AsyncCall
  ...
  private fun promoteAndExecute(): Boolean {
    ...
    synchronized(this) {
      ...
      while (i.hasNext()) {
        ...
        // 正在执行异步请求的任务数 不能大于64个。用来限制同时请求的数量
